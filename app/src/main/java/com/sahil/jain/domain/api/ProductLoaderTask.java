...
import com.sahil.jain.view.adapter.ProductOverViewPagerAdapter;
import com.sahil.jain.view.fragment.ProductListFragment;
...
public class ProductLoaderTask extends AsyncTask<String, Void, Void> {
	...
	protected Void doInBackground(String... params) {
		...
		FakeWebServer.getFakeWebServer().getAllFruitsAndVegie();
